...
export async function POST(req) {
  try {
    ...
    const { name, phone, email, message, propertyName, url } = body;
    ...
    const range = "PropertyResponse!A:Z"; // Adjust based on your sheet structure
    ...
    await sheets.spreadsheets.values.append({
      ...
      resource: {
        values: [
          [name, phone, email, message, propertyName, url, new Date().toISOString()],
        ],
      },
    });
