...
export default function Footer1() {
  ...
  const sendMail = async (e) => {
    e.preventDefault();
    const email = formRef.current["email-form"].value;

    const mailchimpUrl = `https://us15.api.mailchimp.com/3.0/lists/f6ba4c0a05/members/`;
    const apiKey = "13c0fd52e01ce9f0227f39c86a28cbe4-us15";
        ...
        <div className="container">
          <div className="content-footer-top">
            <div className="footer-logo">
              <Link href={`/`}>
                <Image alt="logo" width={250} height={48} src="/images/logo/footerlogo.png" />
              </Link>
            </div>
            <div className="wd-social">
              ...
              <ul className="list-social d-flex align-items-center">
                <li>
                  <a href="https://www.facebook.com/makemyhomezofficial" className="box-icon w-40 social">
                    <svg
                      className="icon"
                      width={9}
                      height={16}
                ...
                <li>
                  <a href="https://x.com/MakeMyHomez" className="box-icon w-40 social">
                ...
                <li>
                  <a href="https://in.pinterest.com/RGLuxuryHomesPH2/" className="box-icon w-40 social">
                ...
                <li>
                  <a href="https://www.instagram.com/make.my.homez/" className="box-icon w-40 social">
                    <svg width={14} height={14} viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                ...
                <li>
                  <a href="https://www.youtube.com/@MakeMyHomezOfficial" className="box-icon w-40 social">
                ...
                <ul className="mt-12">
                  <li className="mt-12 d-flex align-items-center gap-8">
                    ...
                    <p className="text-white">
                      A-801 & 803,Tower-3, Nx-One, Techzone - 4, Greater Noida (West)- 201 306
                    </p>
                  </li>
                  <li className="mt-12 d-flex align-items-center gap-8">
                    <i className="icon icon-phone2 fs-20 text-variant-2" />
                    <a href="tel:+918860460544" className="text-white caption-1">
                      +91 88-604-605-44
                    </a>
                  </li>
                  <li className="mt-12 d-flex align-items-center gap-8">
                    <i className="icon icon-mail fs-20 text-variant-2" />
                    <a href="mailto:info@makemyhomez.in" className="text-white">
                      info@makemyhomez.in
                    </a>
                  </li>
                </ul>
            ...
            {footerSections.map((section, index) => (
              <div key={index} className="col-lg-2 col-md-6">
                <div className={`footer-cl-${index + 2} footer-col-block`}>
                  <div className="fw-7 text-white footer-heading-mobile">{section.heading}</div>
                  <div className="tf-collapse-content">
                    <ul className="mt-10 navigation-menu-footer">
                      {section.links.map((link, linkIndex) => (
                        <li key={linkIndex}>
                          <Link href={link.href} className="caption-1 text-variant-2">
                            {link.label}
                          </Link>
                        </li>
                      ))}
      ...
      <div className="bottom-footer">
        <div className="container">
          <div className="content-footer-bottom">
            <div className="copyright">©{new Date().getFullYear()} Make My Homez. All Rights Reserved.</div>
