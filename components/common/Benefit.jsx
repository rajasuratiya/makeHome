    ...
    <section className="mx-5 bg-primary-new radius-30">
      <div className="flat-img-with-text">
        <div className="content-left img-animation wow">
          <Image
            className="lazyload"
            data-src="/images/home/choose.webp"
            alt=""
            src="/images/home/choose.webp"
            width={950}
            height={908}
          />
        </div>
        <div className="content-right">
          <div className="box-title wow fadeInUp">
            ...
            Why Choose to Make My Homez ?</h3>
            <p className="desc text-variant-1">
            Your trusted partner for smart real estate solutions. Making your home buying journey absolutely hassle free. <br />
