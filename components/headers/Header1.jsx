...
export default function Header1({ parentClass = "main-header header-fixed fixed-header" }) {
            ...
            <div className="inner-header">
              <div className="inner-header-left">
                <div className="logo-box flex align-center">
                  <div className="logo">
                    <Link href={`/`}>
                      <Image alt="logo" width={250} className="logo-1" height={48} src="/images/logo/headerlogo.svg" />
                      <Image
                        alt="logo"
                        width={166}
                        className="logo-2"
