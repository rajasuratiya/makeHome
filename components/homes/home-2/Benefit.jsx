            ...
            <div className="grid-img-group">
              <div className="tf-image-wrap item-1">
                <div className="img-style hover-img-wrap">
                  <Image
                    className="lazyload"
                    data-src="/images/about/about-us-three.jpeg"
                    alt=""
                    src="/images/about/about-us-three.jpeg"
                    width={484}
                    height={465}
                  />
                </div>
              ...
              <div className="tf-image-wrap item-2">
                <div className="img-style hover-img-wrap">
                  <Image
                    className="lazyload"
                    data-src="/images/about/about-us-two.jpeg"
                    alt=""
                    src="/images/about/about-us-two.jpeg"
                    width={842}
                    height={930}
                  />
                </div>
              ...
              <div className="tf-image-wrap item-3">
                <div className="img-style hover-img-wrap">
                  <Image
                    className="lazyload"
                    data-src="/images/about/about-us-one.jpeg"
                    alt=""
                    src="/images/about/about-us-one.jpeg"
                    width={370}
                    height={354}
                  />
                </div>
          ...
          <div className="content-right">
            <div className="box-title wow fadeInUp">
              ...
              <p className="desc text-variant-1">
                Our seasoned professionals, armed with extensive market knowledge, walk alongside you through every
                phase of your property endeavor.
              </p>
            </div>
            <div className="flat-service wow fadeInUp" data-wow-delay=".2s">
              <a href="#" className="box-benefit hover-btn-view">
                ...
                <div className="content">
                  <h5 className="title">🏠 Buy A Home</h5>
                  <p className="description">
                    Find your dream home with expert assistance and a wide selection of properties.
                  </p>
              ...
              <a href="#" className="box-benefit hover-btn-view">
                ...
                <div className="content">
                  <h5 className="title">Replace Rent a Home 📈 Real Estate Investment</h5>
                  <p className="description">
                    Unlock high-value real estate investment opportunities. Get expert insights to maximize returns on
                    your property investments. Make informed decisions with in-depth market analysis and trend
                    forecasting.
                  </p>
                  <span className="btn-view style-1">
                    <span className="text">Explore Now</span>
              ...
              <a href="#" className="box-benefit hover-btn-view">
                ...
                <div className="content">
                  <h5 className="title">🏡 Sell Your Home</h5>
                  <p className="description">
                    Maximize your property’s value with professional marketing and expert insights.
                  </p>
                  <span className="btn-view style-1">
                    <span className="text">Explore Now</span>
                    <span className="icon icon-arrow-right2" />
